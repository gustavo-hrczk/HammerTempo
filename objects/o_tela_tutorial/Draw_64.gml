...
var _box_altura = 800;  // <<< ALTURA IDEAL
var _margin_bottom = 20; // Distância da base da tela
...
draw_set_valign(fa_top); // Alinha o texto pelo topo para melhor controle

// --- TÍTULO ---
draw_set_halign(fa_center);
draw_set_color(c_yellow);
var _titulo_y = _box_y + 40; // Posição relativa ao topo do painel
draw_text(_cx, _titulo_y, "Como Forjar");

// --- INSTRUÇÕES ---
draw_set_halign(fa_left); // Alinhado à esquerda para blocos de texto
draw_set_color(c_black);
var _texto_instrucoes = "Use as SETAS ou WASD do teclado para acertar as notas no ritmo da forja.\n\n" + 
