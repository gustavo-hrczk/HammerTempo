...
// Armazena o texto dos créditos em uma string
credit_text = "CREDITOS \n"+  
"_____________________________________________________ \n" +
"LICENÇA DE USO DE ASSETS \n\n"+ 
"1. INFORMAÇÕES DO JOGO \n\n" + 
"Nome do Jogo: HammerTempo \n\n" + 
"Desenvolvedor: Panela Games \n\n" + 
"Equipe: Beatrice Fischer, Gabriele Maria Freiberger, Gustavo Hreczuck, Lucas de Carvalho Ziele, Raul Schmitz \n\n" + 
...
"Alabarda (Mestre): In Taberna Quando Sumus - Medieval Tunes Vol.1 (1 of 12)\n" +
"Compositor: Desconhecido (Carmina Burana, seculo XIII). Dominio publico.\n" +
"Arranjos e gravacao: The Recorder Maniac \n" +
"Trecho editado em laco de 10 compassos para a duracao da fase. \n\n" +
