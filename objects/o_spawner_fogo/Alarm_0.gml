...
switch (_tipo_random) {
    case 3: // Seta para Baixo
        _pos_y = 558; // Sua posição Y para o alvo de Baixo
        break;
...
var _novo_fogo = instance_create_layer(x, _pos_y, "Gameplay", o_indicador_calor); // Camada "Gameplay"

// 4. Configura a nota que acabamos de criar.
_novo_fogo.origem = posicao;
}
